...
/* Dung de kiem tra kieu ki tu doc duoc (hop le, chuyen trang thai)*/
CharCode charCodes[256] = {
  ...
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER,
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LSR, CHAR_BACKSLASH, CHAR_RSR, CHAR_UNDERSCORE, CHAR_LETTER,
